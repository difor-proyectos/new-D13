# 0a49e6f5-2314-4c2b-880e-d6c362d60b71 implementation handoff
...
- `_routes.json`
- `brand-spec.md`
- `CLOUDFLARE_PAGES_ZIP.md`
- `cloudflare/bindings.example.toml`
- `cloudflare/export-pages-functions.ps1`
- `cloudflare/schema.sql`
- `cloudflare/verify-production.ps1`
- `critique.json`
- `mr0413xh-image.png`
